...
Guarantees auditability aligned with HIPAA, EU MDR, and ONC CDS requirements.
"""
...
class AuditLogger:
    ...
    def log_assessment(
        ...
        entry = {
            ...
            "patient_name": f"{patient.name} ({patient.vitals.age:.1f} yo)",
            "ai_recommendation": {
